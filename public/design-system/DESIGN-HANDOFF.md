# brand-design-md-personal-brand-system-81cbf2 implementation handoff
...
- `fonts/font-9.woff2`
- `guide.md`
- `mr3cemtq-Gemini_Generated_Image_nuicqnnuicqnnuic.png`
- `README.md`
- `SKILL.md`
- `system/artifacts/landing.html.bak`
